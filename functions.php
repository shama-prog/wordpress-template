<?php
	...
	// Set up the WordPress core custom background feature.
		add_theme_support( 'custom-background', apply_filters( 'mdbblog_custom_background_args', array(
	...
	if ( !function_exists( 'bootstrap_script_init' ) ) {
		function bootstrap_script_init() {
            ...
            wp_enqueue_style( 'Font_Awesome', get_template_directory_uri(). 'fonts/css/all.css' );
